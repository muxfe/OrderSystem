...
<div class=line></div>
<form action="user.php" method="post" name="form" id="form">
  <table width="100%" id="adm_comment_list" class="item_list">
	...
	<?php
		...
		foreach($users as $key => $val):
			$avatar = 'content/views/images/avatar.jpg';
	?>
     <tr>
        <td style="padding:3px; text-align:center;"><img src="<?php echo $avatar; ?>" height="40" width="40" /></td>
		<td>
		<?php echo empty($val['name']) ? $val['username'] : $val['name']; ?><br />
		<?php echo $val['role'] == ROLE_ADMIN ? $val['uid'] == 1 ? '创始人':'管理员' : '待定'; ?>
	...
	<?php endforeach;else:?>
	  <tr><td class="tdcenter" colspan="6">还没有添加管理员</td></tr>
	<?php endif;?>
	</tbody>
  </table>
</form>
<div class="page">(有<?php echo $userNum; ?>位用户)</div> 
...
<div id="user_new" class="item_edit" style="display:none;">
    <li>
...
$(document).ready(function(){
	$("#menu_user a").attr("class","current");
